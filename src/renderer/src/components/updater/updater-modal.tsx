...
import { isWeb } from '@renderer/utils/init'
      ...
      <ModalContent className="h-full w-[calc(100%-100px)]">
        <ModalHeader className="flex justify-between app-drag">
          ...
          <Button
            ...
            onPress={() => {
              open(`https://github.com/Swipa5fox/Clash-Party-Web-pvs/releases/tag/v${version}`)
            }}
          >
        ...
        <ModalFooter className="flex-col gap-2 items-stretch">
          ...
          <div className="flex justify-end gap-2">
            ...
            >
              {isWeb ? '请在宿主机应用内更新' : t('common.updater.update')}
            </Button>
          </div>
        </ModalFooter>
      </ModalContent>

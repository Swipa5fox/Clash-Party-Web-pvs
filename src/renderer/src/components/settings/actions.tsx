...
import { platform, isWeb, version } from '@renderer/utils/init'
            ...
            onPress={async () => {
              try {
                ...
                if (version) {
                  ...
                  // web 端无法执行安装（downloadAndInstallUpdate 为宿主专属），只展示更新信息
                  if (appConfig?.silentUpdate !== false && canSilentlyUpdate && !isWeb) {
